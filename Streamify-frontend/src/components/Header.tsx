...
import AccountCircleDark from "/AccountCircleDark.png";
import AccountCircleLight from "/AccountCircleLight.png";
...
const Header: FC = () => {
  ...
  return (
    <header
      className={`flex justify-between items-center ${theme.background?.secondary} px-4 py-2`}
    >
